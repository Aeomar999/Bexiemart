...
- [ ] **RR-1 — Fix mobile root layout routing**
...
- [ ] **RR-3 — Dispatcher createProfile safety**
...
- [ ] **RR-4 — Add role guards to vendor/dispatcher controllers**
...
- [ ] **RR-5 — Add DB-level role validation**
...
- [ ] **RR-6 — Evaluate multi-role support**
...
- [ ] **RR-7 — Update user.role when becoming a vendor**
