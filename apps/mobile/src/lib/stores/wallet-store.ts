...
export type TransactionType = 'DEPOSIT' | 'WITHDRAWAL' | 'ORDER_PAYMENT' | 'TRANSFER_RECEIVED' | 'FEE';
...
interface WalletState {
  ...
  addTransaction: (tx: { type: TransactionType; amount: number; description: string; status: TransactionStatus; reference?: string }) => void;
