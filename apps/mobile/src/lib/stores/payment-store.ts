...
interface PaymentState {
  ...
  addCardMethod: (data: { provider: string; details: string; holderName: string; expiry: string; isDefault?: boolean }) => Promise<void>;
  addMomoMethod: (data: { provider: string; details: string; holderName: string; isDefault?: boolean }) => Promise<void>;
