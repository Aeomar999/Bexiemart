            ...
            <View key={customer.id} className="bg-card rounded-[20px] border border-border p-4">
              <View className="flex-row items-start justify-between mb-4">
                <View className="flex-row items-center">
                  ...
                  >
                    <Text className="text-[16px] font-heading font-black" style={{ color: customer.color }}>
                      {customer.initials}
                    </Text>
                  </View>
                  <View>
                    <Text className="text-[16px] font-bold text-foreground mb-0.5">{customer.name}</Text>
                    <Text className="text-[13px] text-muted-foreground">Last order {customer.lastOrder}</Text>
                  </View>
                </View>
              </View>
              ...
              <View className="flex-row gap-2">
                ...
                >
                  <Icon name="shopping-bag" size={16} color="#64748b" style={{ marginRight: 6 }} />
