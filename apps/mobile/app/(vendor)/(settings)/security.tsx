  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <ScrollView className="flex-1 px-5 pt-6 pb-12" showsVerticalScrollIndicator={false}>
        <View className="bg-card rounded-[24px] border border-border overflow-hidden mb-6">
          ...
          >
            <View>
              ...
              <Text className="text-[12px] text-muted-foreground mt-0.5">Last changed 3 months ago</Text>
            </View>
        ...
        <Text className="text-[16px] font-bold text-foreground mb-3 ml-1">Two-Factor Authentication</Text>
        <Pressable 
        ...
        >
          <View className="flex-row justify-between items-start mb-4">
            <View className="flex-row items-center">
              <View className="w-10 h-10 rounded-full bg-brand-50 items-center justify-center mr-3">
                <Icon name="shield" size={18} color="#004CFF" />
              </View>
              <View>
          ...
          <Text className="text-[13px] text-muted-foreground leading-relaxed">
            We'll ask for a code from your authenticator app when you log in from an unrecognized device or withdraw funds.
          </Text>
        </Pressable>
        ...
        <View className="bg-card rounded-[24px] border border-border overflow-hidden">
          <View className="p-4 border-b border-border flex-row items-center">
            ...
            <View className="flex-1">
              ...
              <Text className="text-[12px] text-brand-600 font-bold">This Device • Active Now</Text>
            </View>
          ...
          <Pressable 
            ...
            style={({ pressed }) => [{ backgroundColor: pressed ? '#f8fafc' : 'white' }]}
            onPress={() => setSelectedDevice({ name: "MacBook Pro", location: "Accra, Ghana", time: "2 days ago" })}
          >
        ...
        <View className="flex-1 justify-end bg-black/40">
          ...
          <View className="bg-card rounded-t-[32px] p-6 pb-12">
            ...
            <View className="items-center mb-6">
              ...
              <Text className="text-[20px] font-heading font-bold text-foreground">{selectedDevice?.name}</Text>
              <Text className="text-[14px] text-muted-foreground mt-1">{selectedDevice?.location} • Last active {selectedDevice?.time}</Text>
            </View>
