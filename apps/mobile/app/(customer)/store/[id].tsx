...
export default function StoreProfileScreen() {
  ...
  if (isStoreError || storeError || isProductsError) {
    return (
      <ErrorState
        message="Failed to load the store. Please check your connection."
        onRetry={() => {
          refetchStore();
          refetchProducts();
        }}
        ...
        ListHeaderComponent={
          <View className="mb-6">
            ...
            <View className="px-5 mt-8 mb-2 flex-row items-center justify-between">
              <Text className="text-heading-sm font-bold font-heading text-foreground">
                Store Collection
              </Text>
              <View className="bg-muted px-3 py-1 rounded-full">
                <Text className="text-caption font-bold text-muted-foreground font-body">
