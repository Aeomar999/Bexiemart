        ...
        <View className="px-5 mt-4">
          ...
          <View className="gap-4 bg-card rounded-2xl p-5 border border-border">
            ...
            <Input
              ...
              placeholder="Gate code, floor number..."
              value={instructions}
          ...
          <View className="gap-3">
            ...
            >
              ...
              <View className="flex-1">
                ...
                <Text className="text-body-sm text-muted-foreground font-body mt-0.5">
                  GHS {balance.toFixed(2)} available
                </Text>
              </View>
            </Pressable>
          </View>
              ...
              onPress={() => {
                if (!useBexieCoins && bexieCoins < 1000) {
                  Toast.show({
                    ...
                    text2: `You need 1000 coins. You have ${bexieCoins}.`,
                  });
                  return;
                }
            ...
            {items.map((item: CartItemData) => (
              ...
              >
                <View className="flex-1 mr-3">
                  <Text
                    className="text-body-sm font-semibold text-foreground font-body"
                    numberOfLines={1}
                  >
