      ...
      <ScrollView className="flex-1 px-5 pt-6 pb-10" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row gap-3 mb-8">
          <View className="flex-1 bg-card border border-border p-3 rounded-2xl items-center">
            ...
            <Text className="text-[12px] text-muted-foreground font-body text-center">Rating</Text>
          </View>
          <View className="flex-1 bg-card border border-border p-3 rounded-2xl items-center">
            <View className="flex-row items-center gap-1 mb-1">
        ...
        <View className="bg-card rounded-[24px] border border-border overflow-hidden mb-8 shadow-[0_10px_20px_rgba(0,0,0,0.02)]">
          <View className="flex-row items-center p-4 border-b border-border">
            ...
            <View className="flex-1">
              <Text className="text-[15px] font-body font-semibold text-foreground">Type</Text>
