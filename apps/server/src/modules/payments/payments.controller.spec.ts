...
describe("PaymentsController", () => {
  ...
  describe("handleWebhook", () => {
    it("should verify signature against the raw body and call service.handleWebhook", async () => {
      ...
      expect(
        await controller.handleWebhook({ rawBody } as AuthenticatedRequest, signature, body)
      ).toEqual(result);
    ...
    it("should reject an invalid signature", async () => {
      ...
      expect(() =>
        controller.handleWebhook({ rawBody } as AuthenticatedRequest, "deadbeef", body)
    ...
    it("should reject when the raw body is missing", async () => {
      ...
      expect(() => controller.handleWebhook({} as AuthenticatedRequest, signature, body)).toThrow(
        "Invalid signature"
      );
