...
export class WalletController {
  ...
  getTransactions(@Req() req: AuthenticatedRequest, @Query("page") page?: string) {
  ...
  initializeTopUp(@Req() req: AuthenticatedRequest, @Body() body: TopupDto) {
  ...
  verifyTopUp(@Req() req: AuthenticatedRequest, @Param("reference") reference: string) {
  ...
  transfer(@Req() req: AuthenticatedRequest, @Body() body: TransferDto) {
  ...
  @ApiBody({ type: PinDto })
  setPin(@Req() req: AuthenticatedRequest, @Body() body: PinDto) {
  ...
  changePin(@Req() req: AuthenticatedRequest, @Body() body: ChangePinDto) {
  ...
  @ApiBody({ type: PinDto })
  verifyPin(@Req() req: AuthenticatedRequest, @Body() body: PinDto) {
  ...
  getPinStatus(@Req() req: AuthenticatedRequest) {
  ...
  addCard(@Req() req: AuthenticatedRequest, @Body() body: CreateCardDto) {
  ...
  setDefaultCard(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
  ...
  getBankAccounts(@Req() req: AuthenticatedRequest) {
  ...
  linkBankAccount(@Req() req: AuthenticatedRequest, @Body() body: LinkBankAccountDto) {
    return this.walletService.linkBankAccount(req.user.id, body);
  }

  @Delete("bank-accounts/:id")
  @ApiOperation({ summary: "Remove a linked bank account" })
  deleteBankAccount(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
  ...
  getMomoAccounts(@Req() req: AuthenticatedRequest) {
  ...
  linkMomoAccount(@Req() req: AuthenticatedRequest, @Body() body: LinkMomoAccountDto) {
  ...
  deleteMomoAccount(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
  ...
  verifyAndSaveCard(@Req() req: AuthenticatedRequest, @Body() body: VerifyCardDto) {
