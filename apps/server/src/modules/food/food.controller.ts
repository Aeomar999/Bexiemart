...
export class FoodController {
  ...
  addToCart(@Req() req: AuthenticatedRequest, @Body() body: AddFoodCartItemDto) {
  ...
  updateCartItem(
    ...
    @Param("id") id: string,
    @Body() body: UpdateFoodCartItemDto
  ) {
  ...
  removeCartItem(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
  ...
  checkout(@Req() req: AuthenticatedRequest, @Body() dto: CheckoutFoodDto) {
